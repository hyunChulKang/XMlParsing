...
public class DOMParsing {
	public void parse() {
		...
		try {
			...
			//( getChildNodes() 보다는, 
			//  getElementsByTagName()을 이용하는게 좋다.)
			Node titleNode = bookN1.item(1); // 공백문자 때문에 인덱스값을 1로 설정
			Element titleElement = (Element)titleNode;
			System.out.println("titleElement.getTageName() => " 
